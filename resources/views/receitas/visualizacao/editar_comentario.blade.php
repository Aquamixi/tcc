<form action="{{url('editar_comentario')}}" method="post">
    ...
    <div class="modal-footer">
        ...
        <input id="enviaComentarioE" class="btn btn-primary col-2 border-0" type="submit" value="Enviar" data-bs-dismiss="modal" style="height:40px; background-color: #ff8c00; color:white"/>
    </div>
</form>