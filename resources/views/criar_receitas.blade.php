            ...
            <div class="container col-6">
                <div class="card bg-transparent border-0 ">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="fonteMaisFamosas"> 
                                <h2>Titulo Da Receita</h2>                       
                            </div>
                            <div class="">
                                <input type="text" class="form-control fonteCriarReceitas" id="exampleFormControlInput1" placeholder="coloque aqui seu titulo">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body " style="height:114px;" >
                                <div class="mb-3">
                                    ...
                                    <input class=" form-control position-absolute bottom-0 start-0 form-control form-control-lg" id="formFileLg" style="height: 114px" type="file">
                                </div>
                            </div> 
                        </div>
                    </div>
                ...
                <div class="card bg-transparent mt-3 mb-5 border-0">                   
                    <div class="card-body height:114px ">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="descrva brevemente a sua "  style="resize: none; height:115.7px;"></textarea>
                    </div>
                </div>
            </div>
            <div class="container col-6">
                <div class="d-flex  align-items-start flex-column" style="height: 116.39px;">
                </div>
                <div class="card bg-transparent mb-5 border-0">                   
                    <div class="card-body height:114px ">
                        <label for="exampleFormControlTextarea1" class="form-label"><h3 class="fonteMaisFamosas">descrição</h3></label>
